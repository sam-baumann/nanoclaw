...
## PDF attachments (WhatsApp & Discord)

When a user sends a PDF on WhatsApp or Discord, it is automatically saved to the `attachments/` directory. The message will include a path hint like:
